...
public class HospitalController implements IHospitalController {
    ...
    public String getAllHospitals(){
        String output = "<table class='bg-light table table-bordered table-hover'><thead class='thead-dark'><tr><th>ID</th><th>Name</th><th>Type</th><th>Description</th><th>Address</th><th>Phone</th><th>Update</th><th>Remove</th></tr></thead>";
